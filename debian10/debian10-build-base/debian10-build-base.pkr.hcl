build {
  ...
  provisioner "shell" {
    ...
    inline = [
      ...
      "echo deb [trusted=yes] http://${var.os_web}/sw/linux/debian/${var.os_ver}/x86_64/dvd01/ buster main contrib >  $F",
      "echo deb [trusted=yes] http://${var.os_web}/sw/linux/debian/${var.os_ver}/x86_64/dvd02/ buster main contrib >> $F",
      "echo deb [trusted=yes] http://${var.os_web}/sw/linux/debian/${var.os_ver}/x86_64/dvd03/ buster main contrib >> $F",
      "echo deb [trusted=yes] http://${var.os_web}/sw/linux/debian/${var.os_ver}/x86_64/dvd04/ buster main contrib >> $F",
      "echo deb [trusted=yes] http://${var.os_web}/sw/linux/debian/${var.os_ver}/x86_64/dvd05/ buster main contrib >> $F",
      "echo deb [trusted=yes] http://${var.os_web}/sw/linux/debian/${var.os_ver}/x86_64/dvd06/ buster main contrib >> $F",
      "cat /etc/os-release"
    ]
  }
